...
import { KeepAdd } from './cmps/keepApp/KeepAdd.jsx'
import { KeepList } from './cmps/keepApp/KeepList.jsx'
import { KeepFilter } from './cmps/keepApp/KeepFilter.jsx'
...
export class KeepApp extends React.Component {
    ...
    saveKeep = (keep) => {
        keepService.save(keep).then(() => {
            eventBus.emit('notification', { msg: 'Change Saved!' });
            this.loadKeeps()
        })
    }
    ...
    removeKeep = (keep) => {
        keepService.removeKeep(keepId).then(() => {
            eventBus.emit('notification', { msg: 'Keep removed!' })
            this.loadKeeps()
        })
    }
